...
class Filter(Base):
    ...
    AnalysisType = Column(Enum(AnalysisType), default=None, nullable=False)
    Frequency    = Column(Enum(Frequency), default=None, nullable=False)
    Duration     = Column(Enum(Duration), default=None, nullable=False)

...
class Demographics(BaseModel):
    ...
    HealthSystemDistribution        : dict[str, int]      = Field(description="Health system group distribution by user counts")
    HospitalDistribution            : dict[str, int]      = Field(description="Hospital group distribution by user counts")
    SurvivorOrCareGiverDistribution : dict[str, int]      = Field(description="Survivor or Caregiver group distribution by user counts")
...
class BasicAnalyticsStatistics(BaseModel):
    ...
    PatientRegistrationHistory   : dict[datetime, int] = Field(description="User registration history")
    PatientDeregistrationHistory : dict[datetime, int] = Field(description="User deregistration history")

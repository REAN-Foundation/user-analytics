...
class UserEngagementMetrics(BaseModel):
      ...
      Stickiness                      : list|dict|None = Field(description="Ratio of DAU to MAU, showing user engagement and loyalty (DAU/MAU).")
      AverageSessionLengthHours       : list|dict|None = Field(description="Average session duration Hours")
      LoginFrequency                  : list|dict|None = Field(description="Average number of sessions per user per day/week/month.")
      RetentionRate                   : list|dict|None = Field(description="Percentage of users who return to the app after their first use (day 1, day 7, day 30).")
